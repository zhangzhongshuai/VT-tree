...
//        rec.begin = min(rec.begin, res[i].frameIndex);
//        rec.end = max(rec.end, res[i].frameIndex);
//        rec.minx = min(rec.minx, res[i].left);
//        rec.maxx = max(rec.maxx, res[i].right);
//        rec.miny = min(rec.miny, res[i].top);
//        rec.maxy = max(rec.maxy, res[i].bottom);
